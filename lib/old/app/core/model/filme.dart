...
class Filme {
  ...
  Filme({required this.id, required this.nomeFilme, required this.posterPath, required this.popularidade, required this.releaseDate, required this.voteCount, required this.genres});
